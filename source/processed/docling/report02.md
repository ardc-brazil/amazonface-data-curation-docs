...
- maintaining the ingestion infrastructure ( /landing\_zone , quarantine, archive, publication repository);
...
1. Upload to the landing zone. The mentor uploads raw native files to /landing\_zone/[mentor\_id]/ . Golden rule: do not rename or manually 'clean' files at this stage; preserve Level 00 as-is.
...
1. Standardization and movement. The curation team moves data from /landing\_zone to the definitive archive (e.g., /archive/raw/ ), applying automated renaming for Level 00.
...
- Automatic action: monitor /landing\_zone for new files.
...
- Input example: data\_logger\_table1.dat
...
- /landing\_zone/[mentor\_id]/ - raw uploads awaiting ingestion
